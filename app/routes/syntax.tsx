  ...
  <div className="space-y-2">
    ...
    <section className="space-y-2">
      ...
      <p>
        ...
        There is no way to disable this functionality; queries that want to use
        regex control characters literally must escape them.
      </p>
      <p>
    ...
    <section className="space-y-2">
      ...
      <p>
        ...
        <Expression>/foo/</Expression> or <Expression>/bar/</Expression> in all
        files that have matches for least one of <Expression>/foo/</Expression>{" "}
        <em>or</em> <Expression>/bar/</Expression>. (To use <code>or</code> as a
        literal expression and not as an operator, double quote it:{" "}
      ...
      <p>
        ...
        with matches for both <Expression>/foo/</Expression> and at least one of{" "}
      ...
      <p>
        ...
        <Expression>/foo/</Expression> in files that do not have matches for
        either <Expression>/bar/</Expression> or <Expression>/baz/</Expression>.{" "}
    ...
    <section className="space-y-2">
      ...
      <p>
        ...
        certain flags, which are themselves composed of a few characters ending
        with a colon.
      </p>
      <p>
        Consider that regex expressions can produce matches both in the content
        of a file and in the <em>name</em> of the file:
        ...
        may have to scroll down or increase the number of files displayed to see
        the content matches for this query). If you only want the expression to
        match file names, use an expression prefixed with <code>file:</code>,
        like <ExampleQuery query="file:README" />. (<code>f:</code> is an
        equivalent abbreviation for <code>file:</code>).
      </p>
      <p>
        The inverse of <code>file:</code>&apos;s specialization of regex
        expressions is <code>content:</code> or <code>c:</code>.{" "}
        <ExampleQuery query="content:README" /> produces only matches that occur
        in the content of files.
      </p>
      <p>
        ...
        <tbody>
          ...
          <tr className="border">
            ...
            <td className="p-1">
              ...
              <Link to="https://ctags.io/">universal ctags</Link> at index time,
              if it was present during indexing
            </td>
            <td className="p-1">
          ...
          <tr className="border">
            ...
            <td className="p-1">
              ...
              <code>archived:yes</code> excludes non-archived repositories. The
          ...
          <tr className="border">
            ...
            <td className="p-1">
              ...
              another while <code>fork:yes</code> excludes repositories that are
              not forks of another. The default is to exclude neither.
            </td>
            <td className="p-1">
          ...
          <tr className="border">
            ...
            <td className="p-1">
              ...
              <code>public:yes</code> excludes private repositories. The default
